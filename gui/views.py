...
class MainWindow(object):
  ...
  def init_UI(self):
    ...
    self.s_vec_pos          = self.window.add_textinfo(self.s_vector_box, 1, "J2000 Position (km): ")
    self.s_vec_vel          = self.window.add_textinfo(self.s_vector_box, 2, "J2000 Velocity (m/s): ")
  ...
  def update_view_threadsafe(self):
    ...
    self.s_time.SetLabel(self.model.state_time)
